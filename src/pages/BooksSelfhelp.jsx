...
function BooksSelfhelp() {
  ...
  const SelfHelpBook = books.filter((book)=> book.category === "Self-Help")
  return (
      <div>
      <Navbar/>
      <img src="SelfBanner.png" alt="banner" className = "w-[90%] h-[430px] overflow-hidden mx-auto rounded-lg my-10"/>
