  ...
  function OrderView({value}) {
    ...
    return (
      <div className="fixed inset-0 z-80 flex items-center justify-center bg-black/50 p-4">
        <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto hide-scrollbar rounded-2xl bg-[#F2EFE9] shadow-xl">
            ...
            <div>
              ...
              <div className="space-y-3">
                {order.items.map((item) => (
                  <div
                    key={item.id}
                    className="flex justify-between items-center p-3 rounded-lg bg-gray-800/10"
                  >
                    <img src={item.image}
                    alt="project image"
                    className = "w-20"
